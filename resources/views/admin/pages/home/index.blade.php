        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-footer">
                    <a href="{{ route('occurrences.index') }}" class="btn btn-sm btn-outline-primary">Ver todas as ocorrências</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <small class="text-muted">
                        <span class="mr-2"><i class="fas fa-circle text-danger" style="font-size: 0.5rem;"></i> Ocorrência</span>
                        <span><i class="fas fa-circle text-primary" style="font-size: 0.5rem;"></i> Motorista em deslocamento</span>
                    </small>
                </div>
                <div class="card-body p-0 position-relative">
                    <div id="dashboard-map-loading" class="p-4 text-center text-muted" style="min-height: 320px; display: flex; align-items: center; justify-content: center;">
                        Carregando mapa…
                    </div>
